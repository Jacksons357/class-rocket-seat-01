...
(0, vitest_1.describe)('Transactions routes', () => {
    ...
    (0, vitest_1.beforeEach)(() => {
        (0, node_child_process_1.execSync)('pnpm run knex migrate:rollback --all');
        (0, node_child_process_1.execSync)('pnpm run knex migrate:latest');
    });
    ...
    (0, vitest_1.it)('should be able to list all transactions', async () => {
        ...
        if (!cookies) {
            throw new Error('Not cookies value');
        }
    ...
    (0, vitest_1.it)('should be able to get a especific transaction', async () => {
        const createTransactionResponse = await (0, supertest_1.default)(app_1.app.server)
            .post('/transactions')
            .send({
            title: 'New transaction',
